...
// ΓöÇΓöÇ Shared Section Title ΓöÇΓöÇ
...
// ΓöÇΓöÇ Premium Hero Banner ΓöÇΓöÇ
...
// ΓöÇΓöÇ Video Carousel Row ΓöÇΓöÇ
...
// ΓöÇΓöÇ Special Movie Theater Row ΓöÇΓöÇ
...
export default function Home() {
  ...
  const CATEGORY_ICONS = {
    Movies: '≡ƒÄ¼', Music: '≡ƒÄ╡', Series: '≡ƒô║', Shorts: 'ΓÜí', Gaming: '≡ƒÄ«', Comedy: '≡ƒÿé', Sports: 'ΓÜ╜'
  };
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1800px] mx-auto sm:px-6">
        ...
        {/* 2. Trending Section */}
        {trending.length > 0 && (
          <VideoRow title="Trending Now" videos={trending} emoji="≡ƒöÑ" />
        )}
        ...
        {Object.entries(categories).map(([cat, vids]) => {
          ...
          return <VideoRow key={cat} title={cat} videos={vids} emoji={CATEGORY_ICONS[cat] || '≡ƒÄÑ'} />;
        })}
