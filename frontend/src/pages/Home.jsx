        ...
        >
          {videos.map((video) => (
            <SwiperSlide key={video.id}>
              <div className="relative w-full h-[220px] md:h-[400px] flex flex-col justify-end overflow-hidden cursor-pointer group rounded-[1.5rem] md:rounded-[2.5rem] shadow-2xl border border-primary" onClick={() => navigate('/watch/' + video.id)}>
